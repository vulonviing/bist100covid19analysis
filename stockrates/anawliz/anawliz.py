...
quarter1_20H = df_3d20["High"][quarter1_20c["stocks"]].reset_index().merge(tur_covid.reset_index(),on="Date",how="left").set_index("Date").loc["2020-01-01":"2020-12-31"]
quarter2_20H = df_3d20["High"][quarter2_20c["stocks"]].reset_index().merge(tur_covid.reset_index(),on="Date",how="left").set_index("Date").loc["2020-01-01":"2020-12-31"]
quarter3_20H = df_3d20["High"][quarter3_20c["stocks"]].reset_index().merge(tur_covid.reset_index(),on="Date",how="left").set_index("Date").loc["2020-01-01":"2020-12-31"]
quarter4_20H = df_3d20["High"][quarter4_20c["stocks"]].reset_index().merge(tur_covid.reset_index(),on="Date",how="left").set_index("Date").loc["2020-01-01":"2020-12-31"]
...
quarter4_20H.to_excel(r"C:\Users\emrec\Desktop\TUBITAK 22 DOSYASI\covid data\test.xlsx")

dfm = quarter1_19H.melt('Date', var_name='stocks', value_name='High')

print(dfm[dfm["High"]>200])

sns.set(font_scale=2.5, context="notebook", style="white")
plt.figure(figsize=(70, 35))
sns.lineplot(
    dfm[dfm["High"].between(20,60)],
    y="High", x="Date", hue="stocks",
    marker="o",
    markersize=10,
    linewidth = 3,
    ).set(title="more than 400 turkish lira")
plt.xticks(rotation=45)
plt.savefig(r'C:\Users\emrec\Desktop\TUBITAK 22 DOSYASI\stockrates\anawliz\test2.png')
