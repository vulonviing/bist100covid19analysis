...
datastoreist19 = pd.read_excel(r"C:\Users\emrec\Desktop\TUBITAK 22 DOSYASI\datastore manipulation\datastoresource\exsrk2019.xlsx")
quarter1_19a = datastoreist19[["pay kodu", "1ceyrek"]]
quarter1_19b = quarter1_19a[quarter1_19a["1ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter2_19a = datastoreist19[["pay kodu", "2ceyrek"]]
quarter2_19b = quarter2_19a[quarter2_19a["2ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter3_19a = datastoreist19[["pay kodu", "3ceyrek"]]
quarter3_19b = quarter3_19a[quarter3_19a["3ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter4_19a = datastoreist19[["pay kodu", "4ceyrek"]]
quarter4_19b = quarter4_19a[quarter4_19a["4ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter1_19c = pd.DataFrame({'stocks': [sa1 + ".IS" for sa1 in quarter1_19b["pay kodu"]]})
quarter2_19c = pd.DataFrame({'stocks': [sa2 + ".IS" for sa2 in quarter2_19b["pay kodu"]]})
quarter3_19c = pd.DataFrame({'stocks': [sa3 + ".IS" for sa3 in quarter3_19b["pay kodu"]]})
quarter4_19c = pd.DataFrame({'stocks': [sa4 + ".IS" for sa4 in quarter4_19b["pay kodu"]]})
quarter1_19H = df_3d19["High"][quarter1_19c["stocks"]].reset_index()
quarter2_19H = df_3d19["High"][quarter2_19c["stocks"]].reset_index()
quarter3_19H = df_3d19["High"][quarter3_19c["stocks"]].reset_index()
quarter4_19H = df_3d19["High"][quarter4_19c["stocks"]].reset_index()

###2020

datastoreist20 = pd.read_excel(r"C:\Users\emrec\Desktop\TUBITAK 22 DOSYASI\datastore manipulation\datastoresource\exsrk2020.xlsx")
quarter1_20a = datastoreist20[["pay kodu", "1ceyrek"]]
quarter1_20b = quarter1_20a[quarter1_20a["1ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter2_20a = datastoreist20[["pay kodu", "2ceyrek"]]
quarter2_20b = quarter2_20a[quarter2_20a["2ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter3_20a = datastoreist20[["pay kodu", "3ceyrek"]]
quarter3_20b = quarter3_20a[quarter3_20a["3ceyrek"] == "XU100"].reset_index().drop(columns="index")
quarter4_20a = datastoreist20[["pay kodu", "5ceyrek"]]
quarter4_20b = quarter4_20a[quarter4_20a["5ceyrek"] == "XU100"].reset_index().drop(columns="index") #ATTENTION!!! named 5ceyrek because DataStore named like that
quarter1_20c = pd.DataFrame({'stocks': [sa1 + ".IS" for sa1 in quarter1_20b["pay kodu"]]})
quarter2_20c = pd.DataFrame({'stocks': [sa2 + ".IS" for sa2 in quarter2_20b["pay kodu"]]})
quarter3_20c = pd.DataFrame({'stocks': [sa3 + ".IS" for sa3 in quarter3_20b["pay kodu"]]})
quarter4_20c = pd.DataFrame({'stocks': [sa4 + ".IS" for sa4 in quarter4_20b["pay kodu"]]})
quarter1_20H = df_3d20["High"][quarter1_20c["stocks"]].reset_index().set_index("Date").loc["2020-01-01" : "2020-03-31"].reset_index()
quarter2_20H = df_3d20["High"][quarter2_20c["stocks"]].reset_index().set_index("Date").loc["2020-04-01" : "2020-06-31"].reset_index()##PROBLEMLİ
quarter3_20H = df_3d20["High"][quarter3_20c["stocks"]].reset_index().set_index("Date").loc["2020-07-01" : "2020-09-31"].reset_index()##PROBLEMLİ
quarter4_20H = df_3d20["High"][quarter4_20c["stocks"]].reset_index().set_index("Date").loc["2020-10-01" : "2020-12-31"].reset_index()
#quarter1_20Hnew = df_3d20["High"][quarter1_20c["stocks"]].reset_index().merge(tur_covid[["new_cases", "new_deaths"]].reset_index(),on="Date",how="left").set_index("Date").loc["2020-01-01":"2020-03-31"].reset_index()
#quarter2_20Hnew = df_3d20["High"][quarter2_20c["stocks"]].reset_index().merge(tur_covid[["new_cases", "new_deaths"]].reset_index(),on="Date",how="left").set_index("Date").loc["2020-04-01":"2020-06-31"].reset_index()
#quarter3_20Hnew = df_3d20["High"][quarter3_20c["stocks"]].reset_index().merge(tur_covid[["new_cases", "new_deaths"]].reset_index(),on="Date",how="left").set_index("Date").loc["2020-07-01":"2020-09-31"].reset_index()
#quarter4_20Hnew = df_3d20["High"][quarter4_20c["stocks"]].reset_index().merge(tur_covid[["new_cases", "new_deaths"]].reset_index(),on="Date",how="left").set_index("Date").loc["2020-10-01":"2020-12-31"].reset_index()

###---

print(quarter4_20H)

dfm = quarter4_20H.melt('Date', var_name='stocks', value_name='High')

fig, ax = plt.subplots()
ax2 = ax.twinx()
dfm.plot(x="High", y="Date", ax=ax)
plt.show()
