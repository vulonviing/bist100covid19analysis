xarray_3d = xr.Dataset({
    stocks[0]: yf.Ticker(stocks[0]).history(start=_start, end=_end),
    stocks[1]: yf.Ticker(stocks[1]).history(start=_start, end=_end),
    stocks[2]: yf.Ticker(stocks[2]).history(start=_start, end=_end),
